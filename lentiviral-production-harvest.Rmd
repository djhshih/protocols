...
3. Prepare 500 µL PEI-OptiMEM mixture (30 μL 1 mg/mL PEI in 470 μL OptiMEM) such that the ratio of μg DNA:μg PEI is 1:3^[optimized ratio needs to be empirically determined] 

4. Add the diluted PEI dropwise while gently flicking the diluted DNA tube. Incubate the mixture 12–15 min at RT.

5. During the incubation, prepare 10 mL of DMEM Complete with 25 uM of chloroquine (final working conc.). 

6. After the incubation, add the DNA:PEI mix to the DMEM-chloroquine and mix well.

7. Remove media out of the previously seeded 10 cm plate.

8. Slowly pipette the transfection mix onto the 10 cm plate, being careful not to disturb the cells.

9. Incubate the cells for 18 h, or until the following morning.

10. Carefully aspirate the media. Replace the media with 10 mL of DMEM Complete or OptiMEM.
...
**scale [accordingly](https://content.protocols.io/files/eg26biprp.pdf)**\
1. Seed cells at seeding density ~6x10^5^ cell/mL in the afternoon prior to the day of transfection in lentivirus packaging medium. Cells are transfected the next day at ∼90-99% confluency. 
> Seed 7.0 x 10^6^ cells in 12 mL for a 10-cm plate.

2. For each 10-cm plate 
- Prepare Tube A: 
  - 1500 µL OptiMEM only
  - 3.97 µg of pMD2.5G
  - 6.07 µg of psPAX2
  - 7.93 µg of expression plasmid
  - 35 µL of P3000 Enhancer

- Prepare Tube B^[Lipofectamine 3000 should be used within 15 min of dilution]:
  - 1500 µL OptiMEM only
  - 41 µL of Lipofectamine 3000

3. Mix Tube A and B. Incubate for 10-20 min at room temperature.
4. Prior to adding mixture, remove half of medium from each plate. (i.e. leaving 6 mL in a 10-cm plate).
5. Replace medium with fresh lentivirus packaging medium 6 h after transfection.
6. Return plate to incubator, incubate overnight at 37°C, 5% CO~2~.

## Harvest 

1. Virus can be harvested 24-72 h post transfection in individual harvests or a combined harvest where all the individual harvests are pooled.^[If pooling harvests, transfer the harvested media to a polypropylene storage tube and store at 4 °C between harvest.]

2. Centrifuge the viral supernatant at 2100 rcf for 5 minutes to pellet any packaging cells that were collected during harvesting.

3. Filter supernatant through a 0.45 μm PES/PVDF filter.

4. For concentrating vector stocks:
...
5. The viral supernatant can be stored at 4°C for several hours but should be aliquoted (50 µL in 1.5 mL screw-cap tubes) and snap frozen in liquid nitrogen and stored at -80 °C as soon as possible to avoid loss of titer.
